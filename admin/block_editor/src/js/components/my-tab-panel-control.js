...
import MyPositionGridControl from './my-position-grid-control';
import MyToggleControl from './my-toggle-control';
import MyAlignButtons from './my-align-buttons';
import MySelectWrapper from './my-select-wrapper';
import MyClassesControl from './my-classes-control';
				...
				},
				{
					...
					container: (
						<div className={ `${ namespace }-tab ${ namespace }-timing-tab` }>
							...
							<MyTextControl
								prop="pcxDuration"
								label={ __( 'Animation Duration', 'polished-content' ) }
								value={ pcxDuration }
								callback={ updateProp }
								min={ 200 }
								max={ 50000 }
							...
							<MyTextControl
								prop="pcxDelay"
								label={ __( 'Animation Delay', 'polished-content' ) }
								value={ pcxDelay }
								callback={ updateProp }
								min={ 0 }
								max={ 10000 }
							...
							<MyTextControl
								...
								label={ __( 'Delay on Reverse', 'polished-content' ) }
