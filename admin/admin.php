  ...
  final class PolishedContentAdmin {
    ...
    */
    public function enqueue_settings_scripts( $hook ) {
      ...
      if ( strpos( $hook, 'settings_page_polished-content' ) !== false ) {
        ...
        wp_enqueue_script(
          'polished-content-vendors', 
          plugins_url( 'options_page/dist/js/vendors/polished-content-vendors.min.js', __FILE__ ),
          array( 'wp-i18n' ), 
          $this->version,
          true 
        );		
        ...
        wp_enqueue_script(
          ...
          array( 'polished-content-vendors' ), 
          $this->version,
          true 
        );			
    ...
    */
    public function enqueue_block_scripts() {
      ...
      if ( $userCanUse ) {
        wp_enqueue_script(
          'polished-content-js-vendors', 
          plugins_url( 'block_editor/dist/js/vendors/polished-content-vendors.min.js', __FILE__ ),
        ...
        wp_enqueue_script(
          ...
          array( 'polished-content-js-vendors' ), 
          $this->version,
          false 
        );
