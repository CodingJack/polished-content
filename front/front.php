...
if ( ! class_exists( 'PolishedContentFront' ) ) {
  ...
  final class PolishedContentFront {
    ...
    public function __construct() {
      ...
      $this->vendorScriptUrl = plugins_url( 'dist/js/vendors/polished-content-vendors.min.js', __FILE__ );
                ...
                (function(){
                  function onReady(){
                    ...
                    if (window.polishedContent !== undefined){
                      ...
                      vendors.src="' . $this->vendorScriptUrl . '?' . $this->version . '";
